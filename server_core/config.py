...
FAST_TRAINING_MODE = _env_flag('OKX_FAST_TRAINING') or (DEMO_MODE and not _env_flag('OKX_DISABLE_FAST_TRAINING'))
...
MARKET_UNIVERSE_LIMIT = _int_env('OKX_MARKET_UNIVERSE_LIMIT', 100)
MARKET_UNIVERSE_REFRESH_SECONDS = _int_env('OKX_MARKET_UNIVERSE_REFRESH_SECONDS', 3600)
MARKET_ROUTER_ENABLED = not _env_flag('OKX_DISABLE_MARKET_ROUTER')
MARKET_ROUTER_OWNER_TTL_SECONDS = _int_env('OKX_MARKET_ROUTER_OWNER_TTL_SECONDS', 600)
MARKET_ROUTER_MIN_CONFIDENCE = _float_env('OKX_MARKET_ROUTER_MIN_CONFIDENCE', 0.42)
MARKET_ROUTER_MIN_SCORE_GAP = _float_env('OKX_MARKET_ROUTER_MIN_SCORE_GAP', 0.06)
MARKET_ROUTER_EVENT_LIMIT = _int_env('OKX_MARKET_ROUTER_EVENT_LIMIT', 2000)
...
EARLY_LOSS_FIREWALL_MIN_SAMPLE = _int_env('OKX_EARLY_LOSS_FIREWALL_MIN_SAMPLE', 8)
EARLY_LOSS_FIREWALL_MAX_PF = _float_env('OKX_EARLY_LOSS_FIREWALL_MAX_PF', 0.75)
EARLY_LOSS_FIREWALL_MAX_EXPECTANCY = _float_env('OKX_EARLY_LOSS_FIREWALL_MAX_EXPECTANCY', 0.0)
TRAINING_PROBE_ENABLED = _env_flag('OKX_TRAINING_PROBE') or (DEMO_MODE and not _env_flag('OKX_DISABLE_TRAINING_PROBE'))
TRAINING_PROBE_MARGIN_USDT = _float_env('OKX_TRAINING_PROBE_MARGIN_USDT', 8.0)
TRAINING_PROBE_TARGET_RR_MULT = _float_env('OKX_TRAINING_PROBE_TARGET_RR_MULT', 1.15)
TRAINING_PROBE_MIN_PROFIT_MULT = _float_env('OKX_TRAINING_PROBE_MIN_PROFIT_MULT', 1.10)
TRAINING_PROBE_MIN_CONFIDENCE_BY_MODE = {
    'MacroSniper': _float_env('OKX_PROBE_MIN_CONF_MACRO', 0.82),
    'MeanReversion': _float_env('OKX_PROBE_MIN_CONF_MEAN', 0.66),
    'Contrarian': _float_env('OKX_PROBE_MIN_CONF_CONTRARIAN', 0.70),
    'SqueezeHunter': _float_env('OKX_PROBE_MIN_CONF_SQUEEZE', 0.82),
}
MARKET_ROUTER_LIVE_MIN_CONFIDENCE_BY_MODE = {
    'MacroSniper': _float_env('OKX_ROUTER_LIVE_MIN_CONF_MACRO', 0.70),
    'MeanReversion': _float_env('OKX_ROUTER_LIVE_MIN_CONF_MEAN', 0.58),
    'Contrarian': _float_env('OKX_ROUTER_LIVE_MIN_CONF_CONTRARIAN', 0.62),
    'SqueezeHunter': _float_env('OKX_ROUTER_LIVE_MIN_CONF_SQUEEZE', 0.70),
}
...
MIN_EXPECTED_NET_PROFIT_USDT = _float_env('OKX_MIN_EXPECTED_NET_PROFIT_USDT', 0.45 if FAST_TRAINING_MODE else 2.0)
MIN_GROSS_TO_COST_RATIO = _float_env('OKX_MIN_GROSS_TO_COST_RATIO', 1.6 if FAST_TRAINING_MODE else 2.0)
...
PROTECTION_VERIFY_TIMEOUT_SECONDS = _float_env('OKX_PROTECTION_VERIFY_TIMEOUT_SECONDS', 8.0)
PROTECTION_VERIFY_POLL_SECONDS = _float_env('OKX_PROTECTION_VERIFY_POLL_SECONDS', 0.5)
...
SCAN_LOOP_SECONDS = _float_env('OKX_SCAN_LOOP_SECONDS', 12 if FAST_TRAINING_MODE else 60)
SCAN_SYMBOLS_PER_LOOP = _int_env('OKX_SCAN_SYMBOLS_PER_LOOP', 100)
ZERO_SAMPLE_ENTRY_TOLERANCE_MULT = _float_env('OKX_ZERO_SAMPLE_ENTRY_TOLERANCE_MULT', 1.18 if FAST_TRAINING_MODE else 1.0)
ZERO_SAMPLE_MIN_PROFIT_MULT = _float_env('OKX_ZERO_SAMPLE_MIN_PROFIT_MULT', 0.85 if FAST_TRAINING_MODE else 1.0)
ZERO_SAMPLE_TARGET_RR_MULT = _float_env('OKX_ZERO_SAMPLE_TARGET_RR_MULT', 0.90 if FAST_TRAINING_MODE else 1.0)
...
ACCOUNT_SESSION_BASELINE_FILE = str(PROJECT_DIR / f'account_session_baseline_{NODE_NAME}.json')
